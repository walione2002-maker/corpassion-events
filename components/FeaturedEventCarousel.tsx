    ...
    >
      ...
      {openEventsCount > 1 && (
        <button
          ...
          className="absolute right-2 md:right-[-20px] top-1/2 -translate-y-1/2 z-20 flex items-center justify-center w-11 h-11 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/10 shadow-[0_4px_12px_rgba(0,0,0,0.1)] text-brand-600 dark:text-brand-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
        >
      ...
      <div className="relative bg-white/60 dark:bg-slate-900/60 backdrop-blur-3xl border border-slate-200/50 dark:border-white/10 rounded-3xl p-6 sm:p-8 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] overflow-hidden transition-transform duration-500 hover:-translate-y-2">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <h3 className="text-2xl sm:text-3xl font-display font-bold text-slate-900 dark:text-white mb-2 leading-tight line-clamp-2">
              {currentEvent.title}
            </h3>
