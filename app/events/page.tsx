    ...
    <main className="min-h-screen bg-[#050505] pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-display font-bold tracking-tight text-white mt-4 mb-4">
            Global Summits
          </h1>
          ...
          {events.map((event) => (
            <motion.div key={event.id} variants={itemVariants}>
              <Link href={`/events/${event.id}`} className="block h-full outline-none">
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 hover:border-brand-500/50 rounded-3xl overflow-hidden group h-full flex flex-col shadow-[0_10px_30px_rgba(0,0,0,0.5)] hover:shadow-[0_20px_50px_rgba(34,211,238,0.2)] transition-all duration-500 hover:-translate-y-2">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <h2 className="text-xl font-display font-bold text-white mb-3 group-hover:text-brand-300 transition-colors">
                      {event.title}
                    </h2>
